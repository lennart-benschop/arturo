...
void TESTShowUSBRootDirectory(void) {
    ...
    s = "inline.bas";e = FSYSFileInformation(s,&fi);CONWriteString("Info (%d) %s %d %d ",e,s,fi.length,fi.isDirectory);
    s = "inline.xxx";e = FSYSFileInformation(s,&fi);CONWriteString("Info (%d) %s %d %d ",e,s,fi.length,fi.isDirectory);
    s = "aadir";e = FSYSFileInformation(s,&fi);CONWriteString("Info (%d) %s %d %d ",e,s,fi.length,fi.isDirectory);
